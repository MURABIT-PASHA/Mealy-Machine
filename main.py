...
state_label = Label(master=frame, text="Type your states: ")
...
def create_scheme(alphabet, state, main_frame):
    Scheme(alphabet=alphabet, state_number=state, main_frame=main_frame)

scheme_button = Button(master=frame, text="Create Scheme",
                       command=lambda: create_scheme(alphabet_entry.get(), state_entry.get(), frame))
